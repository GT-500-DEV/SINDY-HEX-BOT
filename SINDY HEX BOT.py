...
def GT500_msg(mess, data, clin):
    data = data[12:22]
    api_url = f"https://long-message-gt-500.vercel.app/PaCKet-Msg-Gt-500?Id={data}&Msg={mess}&Key=GT-500-QF"
    try:
...
#################################
    ...
    def fake_friend(self, client, id: str):
        if len(id) == 8:
            packet = '060000007708d4d7faba1d100620022a6b08cec2f1051a1b5b3030464630305d2b2b2020202047484f53545b30304640305d32024d454049b00101b801e8078d0ad03e001b2dd8dae03ea011eefbca8ef2efbcafefbcb3efbca8efbca9efbcadefbca1efa3bf8002fd98a8dd03900201d00201'
            packet = re.sub(r'cec2f105', id, packet)
            client.send(bytes.fromhex(packet))
        elif len(id) == 10:
            packet = '060000006f08d4d7faba1d100620022a6308fb9db9ae061a1c5b303464630305d2b2be385a447484f535420205b3030464630305d32024d454040b00113b801e71cd801d4d8d0ad03e00191db8dae03ea010a5a459534e47f00101f801911a8002fd98a8dd03900201d0020ad80221'
...
#################################
    ...
    def help01(self):
        helprbgx = f"120000018d08{self.EncryptedPlayerid}101220022a800308{self.EncryptedPlayerid}10{self.EncryptedPlayerid}"
        if self.sock1200:
...
#################################
    ...
    def help00(self):
        helprbgx = f"120000018d08{self.EncryptedPlayerid}101220022a800308{self.EncryptedPlayerid}10{self.EncryptedPlayerid}"
        if self.sock1200:
            self.sock1200.send(bytes.fromhex(helprbgx))
        else:
            print("[!] sock0500 not assigned.")
...
#################################
    ...
    def help03(self):
        helprbgx = f"120000018d08{self.EncryptedPlayerid}101220022a800308{self.EncryptedPlayerid}10{self.EncryptedPlayerid}"
        if self.sock1200:
            self.sock1200.send(bytes.fromhex(helprbgx))
        else:
            print("[!] sock0500 not assigned.")                    
...
#################################
    ...
    def help04(self):
        helprbgx = f"120000018d08{self.EncryptedPlayerid}101220022a800308{self.EncryptedPlayerid}10{self.EncryptedPlayerid}"
        if self.sock1200:
            self.sock1200.send(bytes.fromhex(helprbgx))
        else:
            print("[!] sock0500 not assigned.")
...
#################################
    ...
    def help05(self):
        helprbgx = f"120000018d08{self.EncryptedPlayerid}101220022a800308{self.EncryptedPlayerid}10{self.EncryptedPlayerid}"
        if self.sock1200:
            self.sock1200.send(bytes.fromhex(helprbgx))
        else:
            print("[!] sock0500 not assigned.")
...
#################################
    ...
    def help06(self):
        helprbgx = f"120000018d08{self.EncryptedPlayerid}101220022a800308{self.EncryptedPlayerid}10{self.EncryptedPlayerid}"
        if self.sock1200:
            self.sock1200.send(bytes.fromhex(helprbgx))
        else:
            print("[!] sock0500 not assigned.")
...
#################################
    ...
    def help07(self):
        helprbgx = f"120000018d08{self.EncryptedPlayerid}101220022a800308{self.EncryptedPlayerid}10{self.EncryptedPlayerid}"
        if self.sock1200:
            self.sock1200.send(bytes.fromhex(helprbgx))
        else:
            print("[!] sock0500 not assigned.")
...
#################################
    ...
    def help08(self):
        helprbgx = f"120000018d08{self.EncryptedPlayerid}101220022a800308{self.EncryptedPlayerid}10{self.EncryptedPlayerid}"
        if self.sock1200:
            self.sock1200.send(bytes.fromhex(helprbgx))
        else:
            print("[!] sock0500 not assigned.")
...
#################################
    ...
    def help09(self):
        helprbgx = f"120000018d08{self.EncryptedPlayerid}101220022a800308{self.EncryptedPlayerid}10{self.EncryptedPlayerid}"
        if self.sock1200:
            self.sock1200.send(bytes.fromhex(helprbgx))
        else:
            print("[!] sock0500 not assigned.")
...
#################################
    ...
    def help10(self):
        helprbgx = f"120000018d08{self.EncryptedPlayerid}101220022a800308{self.EncryptedPlayerid}10{self.EncryptedPlayerid}"
        if self.sock1200:
            self.sock1200.send(bytes.fromhex(helprbgx))
        else:
            print("[!] sock0500 not assigned.")
...
#################################
    ...
    def help11(self):
        helprbgx = f"120000018d08{self.EncryptedPlayerid}101220022a800308{self.EncryptedPlayerid}10{self.EncryptedPlayerid}"
        if self.sock1200:
            self.sock1200.send(bytes.fromhex(helprbgx))
        else:
            print("[!] sock0500 not assigned.")
...
#################################
    ...
    def help12(self):
        helprbgx = f"120000018d08{self.EncryptedPlayerid}101220022a800308{self.EncryptedPlayerid}10{self.EncryptedPlayerid}"
        if self.sock1200:
            self.sock1200.send(bytes.fromhex(helprbgx))
        else:
            print("[!] sock0500 not assigned.")
...
#################################
    ...
    def help13(self):
        helprbgx = f"120000018d08{self.EncryptedPlayerid}101220022a800308{self.EncryptedPlayerid}10{self.EncryptedPlayerid}"
        if self.sock1200:
            self.sock1200.send(bytes.fromhex(helprbgx))
        else:
            print("[!] sock0500 not assigned.")
...
#################################
    ...
    def handle_likes(self, data_hex, client):
        try:
            ...
            if match:
                uid = match.group(1)
                GT500_msg(f"{generate_random_color()}- تم استقبل الايدي وجاري ارسال 100 لايك لاغير\n\n- يرجى الانتضار....", data_hex, client)

                result = likes_plus(uid)
                GT500_msg(f"{generate_random_color()} {result}", data_hex, client)
                
        except Exception as e:
            print(f"[!] Error in /like id command: {e}")  
...
#################################
                ...
                if '1200' in data.hex()[0:4] and b'/help' in data and not self.RbGx:
                  ...
                  try:
                    ...
                    threading.Thread(target=self.help00).start()     
